...
#adds a list of the cheese pizza size options under the picture
...
#buttons to add selection to the cart
addPizza = Button(pizza, text="Add to cart", command = addPizza)
addPizza.grid(row=6, column=5)

deletePizza = Button(pizza, text="Delete item", command = deletePizza)
